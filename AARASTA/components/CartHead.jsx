      ...
      <div className="text-center md:text-left">
        <p className="text-sm md:text-base">
          <span className="font-semibold">
            Delivery available in Islamabad and Rawalpindi Only, with Cash On Delivery (COD) service.
          </span>
          <br />
          <span className="text-gray-300">
            We are continuously expanding our delivery service to other areas and exploring additional delivery options/methods.
          </span>
        </p>
