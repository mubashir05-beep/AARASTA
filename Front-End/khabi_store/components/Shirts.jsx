        ...
        >
          ...
          <Link href="/shirts">
            <Image
              ...
              } h-[660px] object-contain transition-transform duration-500 `}
              height={200}
              width={500}
            />
            </Link>
          ...
          <Link href="/shirts"> <h1
              className={`${
                isHovered ? "scale-105" : "scale-85"
              } transition-transform duration-500 text-[3rem] font-semibold`}
            >
              Shirts
            </h1></Link>
            <p>
              ...
              attention to detail, our shirts offer a perfect fit and
              exceptional quality.
            </p>
            <Link href="/shirts">
